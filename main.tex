    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
              ...
              \item Fine-Tuned large language models (Ollama and Mistral LLMs) using Low Rank Adaptation (LoRA) and RAG, later deployed to production as part of metadata validation pipeline.
              ...
              \item Designed and developed the UI application, with integrated locally hosted LLM to aid the data curation officers workflow.
            \end{highlights}
        \end{onecolentry}
