...
\begin{document}
    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                \item \textbf{Thesis: Innovations to fundamental stock valuations: Estimating future earnings per share and free cash flows using statistical and machine learning methods.}
                \item Lead workshops on Linux and Software Development Tooling.
                \item Held pair-programming sessions with peers to work on other PhD projects.
            \end{highlights}
        \end{onecolentry}
    ...
    \section{Experience}
        ...
        \begin{onecolentry}
            \begin{highlights}
              \item Designed AI-driven solutions (ML, LLM, GenAI) for automation of existing data pipelines.
              \item Deployment of these solutions to AWS, using Lambda, Step-Functions, EFS.
              \item Applied Python and TDD practices to create and manage data pipelines.
            \end{highlights}
        \end{onecolentry}
        ...
        \begin{twocolentry}{
            ...
            \textbf{Research Officer and Labratory Assistant}, University of Essex -- Colchester, UK\end{twocolentry}

        \vspace{0.10 cm}
        \begin{onecolentry}
            \begin{highlights}
                  \item Participated in mathematical formulation and optimization of a macroeconomic model.
        ...
        \begin{twocolentry}{
            ...
            \textbf{Analyst Intern}, University of Essex -- Colchester, UK\end{twocolentry}
    ...
    \section{Technologies}
        ...
        \begin{onecolentry}
            \textbf{Languages:} C++, C, C\#, SQL, JavaScript, Python.
        \end{onecolentry}

        \vspace{0.2 cm}

        \begin{onecolentry}
            \textbf{Technologies:} .NET, Linux, Docker, AWS.
        \end{onecolentry}
